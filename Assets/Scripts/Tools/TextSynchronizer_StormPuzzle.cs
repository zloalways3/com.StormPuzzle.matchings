...
public class TextSynchronizer_StormPuzzle : MonoBehaviour
{
    public TMP_Text sourceText_StormPuzzle;
    public TMP_Text targetText_StormPuzzle;
    ...
    public void SynchronizeText_StormPuzzle()
    {

        targetText_StormPuzzle.text = sourceText_StormPuzzle.text;
