...
public class InvokerEventDelay_StormPuzzle : MonoBehaviour
{
    [SerializeField] private float seconds_StormPuzzle;
    ...
    public async void TriggerEvent_StormPuzzle()
    {
        await Task.Delay(TimeSpan.FromSeconds(seconds_StormPuzzle));
